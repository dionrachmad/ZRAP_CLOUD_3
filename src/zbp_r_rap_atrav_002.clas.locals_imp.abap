CLASS lhc_zr_rap_atrav_002 DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
...
CLASS lhc_zr_rap_atrav_002 IMPLEMENTATION.
  ...
  METHOD earlynumbering_create.
    ...
    DATA:
      entity           TYPE STRUCTURE FOR CREATE zr_rap_atrav_002,
    ...
    ELSE.
      ...
      SELECT SINGLE FROM zrap_atrav_002 FIELDS MAX( travel_id ) AS travelId INTO @travel_id_max.
      "Get max travel ID from draft table
      SELECT SINGLE FROM zrap_atrav_002_d FIELDS MAX( travelid ) INTO @DATA(max_travelid_draft).
  ...
  METHOD setStatusToOpen.
    ...
    READ ENTITIES OF zr_rap_atrav_002 IN LOCAL MODE
     ENTITY Travel
    ...
    MODIFY ENTITIES OF zr_rap_atrav_002 IN LOCAL MODE
      ENTITY Travel
        UPDATE SET FIELDS
...
**************************************************************************
  METHOD deductDiscount.
    DATA travels_for_update TYPE TABLE FOR UPDATE zr_rap_atrav_002.
...
**************************************************************************
  METHOD copyTravel.
    DATA:
       travels       TYPE TABLE FOR CREATE zr_rap_atrav_002\\travel.
