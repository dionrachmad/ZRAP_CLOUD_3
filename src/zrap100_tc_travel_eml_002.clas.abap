"! @testing BDEF:ZR_RAP_ATRAV_002
CLASS zrap100_tc_travel_eml_002 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC
...
CLASS ZRAP100_TC_TRAVEL_EML_002 IMPLEMENTATION.
  ...
  METHOD create_with_action.
    ...
    MODIFY ENTITIES OF zr_rap_atrav_002
     ENTITY Travel
    ...
    SELECT * FROM zr_rap_atrav_002 INTO TABLE @DATA(lt_travel). "#EC CI_NOWHERE
