CLASS zcl_rap_gen_data_002 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_RAP_GEN_DATA_002 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA : group_id   TYPE string VALUE '002',
...
*   clear data
    DELETE FROM zrap_atrav_002.
*    DELETE FROM zrap100_dtrav###.

    "insert travel demo data
    INSERT zrap_atrav_002 FROM (
